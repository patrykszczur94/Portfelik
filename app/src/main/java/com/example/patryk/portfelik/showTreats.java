...
public class showTreats extends AppCompatActivity {

    private String jsonResult;
    private String url = "http://ratcooding.site88.net/showTreats.php";
    ...
    int sum = 0;
    TextView sumTreatsTv;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_show_treats);
        listView = (ListView) findViewById(R.id.listView6);
        accessWebService();
        onPreExecute();
        sumTreatsTv = (TextView) findViewById(R.id.sumTreatsTv);
    }
    protected void onPreExecute() {
        pDialog = new ProgressDialog(showTreats.this);
    ...
    public void accessWebService() {
        showTreats.JsonReadTask task = new showTreats.JsonReadTask();
        task.execute(url);
    }
    ...
    public void ListDrawer() {
        try {
            ...
            for (int i = 0; i < jsonMainNode.length() ; i++) {
                ...
                sum += sumExpenses ;
                sumTreatsTv.setText("On rest of the things you have spent" + "  " + sum + "  " + "$");
