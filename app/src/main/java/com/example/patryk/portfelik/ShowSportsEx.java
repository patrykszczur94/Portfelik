...
public class ShowSportsEx extends AppCompatActivity {

    private String jsonResult;
    private String url = "http://ratcooding.site88.net/showExpenseSport.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_sports_ex);
        listView = (ListView) findViewById(R.id.listView2);
        accessWebService();
        onPreExecute();
        sumSportTv = (TextView) findViewById(R.id.sumSportTv);

    }

    protected void onPreExecute() {

        pDialog = new ProgressDialog(ShowSportsEx.this);
    ...
    public void accessWebService() {
        ShowSportsEx.JsonReadTask task = new ShowSportsEx.JsonReadTask();
        task.execute(url);
    }
    ...
    public void ListDrawer() {
        try {
            ...
            for (int i = 0; i < jsonMainNode.length() ; i++) {
                ...
                sum += sumExpenses ;
                sumSportTv.setText("On sport you have spent" + "  " + sum + "  " + "$");
        ...
        ListAdapter adapter = new SimpleAdapter(
                ShowSportsEx.this, expensesList,
