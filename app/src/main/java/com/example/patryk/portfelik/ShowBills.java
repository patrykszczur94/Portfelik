...
public class ShowBills extends AppCompatActivity {
    ...
    private String url = "http://ratcooding.site88.net/showBills.php";
    private ListView listView;

    String description;
    Integer expense;
    TextView sumBillsTvv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accessWebService();
        onPreExecute();
        sumBillsTvv = (TextView) findViewById(R.id.textView10);
    }

    protected void onPreExecute() {
        // Showing progress dialog
        pDialog = new ProgressDialog(ShowBills.this);
    ...
    public void accessWebService() {
        ShowBills.JsonReadTask task = new ShowBills.JsonReadTask();
        task.execute(url);
    }
    ...
    public void ListDrawer() {
        try {
            ...
            for (int i = 0; i < jsonMainNode.length() ; i++) {
                ...
                sum += sumExpenses ;
                sumBillsTvv.setText("On bills you have spent" + "  " + sum + "  " + "$");
